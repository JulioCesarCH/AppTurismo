                    ...
                    <div class="enlaces-header">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="/st/alojamiento">Alojamiento</a></li>
                                <li><a class="dropdown-item" href="/st/restaurante">Restaurantes</a></li>
                                <li><a class="dropdown-item" href="/st/transporte">Transporte</a></li>
                                <li><a class="dropdown-item" href="/st/clinicas">Clinicas</a></li>
                            </ul>
                        </li>

                        @Auth
                        @if(session('tipo')==1 || session('tipo')==2 || session('tipo')==3 )
